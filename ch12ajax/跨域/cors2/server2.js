...
/*    res.setHeader('Access-Control-Allow-Origin','http://127.0.0.1:8888');
    res.setHeader('Access-Control-Allow-Headers','X-Test-Cors');  // 增加允许跨域请求的头
    res.setHeader('Access-Control-Allow-Methods','DELETE');   // 增加允许跨域请求的方法
    res.setHeader('Access-Control-Max-Age','2000');   // 增加允许*/
    res.writeHead(200,{
...
对于非简单请求,
比如1、Method为POST且Content-Type值为 application/json 的请求
